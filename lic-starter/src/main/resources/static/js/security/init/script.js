class Steps {
    constructor(wizard) {
        ...
        this.currentStep = parseInt(charAt) - 1;
    }
...
class Wizard {
    ...
    updtadeCurrentStep(movement) {
        ...
        this.handleNextStepButton();//下一步
        this.updateButtonsStatus();//更新按钮状态
    }

    handleNextStepButton() {
        if (this.currentStep === this.stepsQuantity - 1) {
            this.nextControl.innerHTML = '完成！';
            this.nextControl.addEventListener('click', otherSet());
            ...
            if (this.currentStep === 1) {
                this.nextControl.addEventListener('click', add());
            } else if (this.currentStep === 2) {
                this.nextControl.addEventListener('click', cacheSystem());
            }
